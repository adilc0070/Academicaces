...
function AdminDashboard() {
    ...
    const [pageContent, setPageContent] = useState('Students');
            ...
            <nav className="bg-blue-900 border-gray-200 w-full">
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
                    ...
                    <div className="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
                        <p onClick={() => Logout()} className="text-gray-200 hover:text-white focus:text-white dark:text-gray-400">Logout</p>
                    </div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <div className="flex items-center">
                                            ...
                                            <span className="ml-2">{admin?.email || 'Profile'}</span>
                                        </div>
                                    ...
                                    >
                                        <p onClick={() => Logout()} className="block py-2 px-4 text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Logout</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
            ...
            <div className='flex w-screen h-auto'>
                ...
                <div className="flex ">
                    ...
                    >
                        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
                            <ul className="space-y-2 font-medium">
                                {['Students', 'Instructors'].map((item, index) => (
                                    <li key={index}>
                                        <p
                                            onClick={() => setPageContent(item)}
                            ...
                            >
                                ...
                                <p className="mb-3 w-[200px] text-sm text-blue-800 dark:text-blue-400 break-words">
                                    this is a notification message component
                                </p>
                                <a
                                    className="text-sm text-blue-800 underline font-medium hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300"
                                    href="#"
                                >Here is the link for the notification
                    ...
                    <div className='p-4 shadow-md'>
                        {pageContent === 'Students' && <Test data={students} title={'Students'} block={block}/>}
                        {pageContent === 'Instructors' && <Test data={[]} title={'Instructors'} block={block}/>}
