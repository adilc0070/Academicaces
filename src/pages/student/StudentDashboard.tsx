                            ...
                            !student.email ?
                                ...
                                (
                                    <>
                                        ...
                                        <p onClick={() => signOut()}  className="text-gray-200 hover:text-white focus:text-white dark:text-gray-400">Logout</p>
                                    </>
                                )
            ...
            <div className='flex w-screen h-auto'>
                ...
                <div className="flex ">
                    ...
                    <div className='p-4 shadow-md'>
                        ...
                        <p className="text-lg mb-4">Welcome, {student.name}!</p>
                        <p className="text-lg mb-4">Your email is: {student.email}</p>
                        <p className="text-lg mb-4">Your role is: {student.role}</p>
                    </div>
                </div>
            </div>
        </section>
